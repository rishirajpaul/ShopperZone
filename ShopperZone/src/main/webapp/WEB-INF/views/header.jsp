...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="test"><i class="fas fa-shopping-cart"></i>SHOPPERZONE</a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <c:if test="${pageContext.request.userPrincipal.name!=null}"><li><a href="customerProfile/${pageContext.request.userPrincipal.name}">Hello ${pageContext.request.userPrincipal.name}</a></li></c:if>
