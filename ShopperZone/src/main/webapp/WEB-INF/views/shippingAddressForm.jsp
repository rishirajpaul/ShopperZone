...
<div class="container">
	<div class="row">
        ...
        <h1 align="center">Register Billing Address</h1>
    		<form:form method="post" action="/ShopperZone/cart/createorder">
    			<div class="control-group">
    				<label for="apartmentnumber" class="control-label" >	
    					Apartment No:
    				</label>
    				<div class="controls">
    					<input name="apartmentnumber" type="text" style="width:500px" value="" placeholder="Apartment number"  >
				...
				<div class="control-group">
    				...
    				<div class="controls"><input name="zipcode" type="text" value="" id="zip" placeholder=" Zip code"style="width:500px" required="true">
    				</div>
    			</div><br>
				<div class="control-group">
