package com.niit.ShopperZone.controller;
...
import com.niit.ShopperZone.DAO.CartDao;
import com.niit.ShopperZone.DAO.CartItemsDao;
import com.niit.ShopperZone.DAO.CategoryDao;
import com.niit.ShopperZone.DAO.UserDao;
import com.niit.ShopperZone.model.Cart;
...
public class UserController {
	...
	//customer profile call by id.....
	
	@RequestMapping(value="/customerProfile/{id}")  
	 public ModelAndView edit(@PathVariable String id,HttpSession session){  
	      User user=userDao.getUserById(id);
	      session.setAttribute("userDescription", user);
	     return new ModelAndView("customerProfile","userDescription",user);  
	 }
